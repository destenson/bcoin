...
Wallet.prototype.toRaw = function toRaw() {
  ...
  // bw.writeU32(this.masterIndex || -1);
  // bw.writeVarString(this.masterPath || '', 'ascii');
...
Wallet.prototype.fromRaw = function fromRaw(data) {
  ...
  // this.masterIndex = bw.readU32();
  // if (this.masterIndex === -1) this.masterIndex = null;
  // this.masterPath = bw.readVarString('ascii');
  // if (this.masterPath === '') this.masterPath = null;
