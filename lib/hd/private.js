...
HDPrivateKey.prototype.derive = function derive(index, hardened, cache) {
  ...
  // console.log("derivation happens", index, hardened);
...
HDPrivateKey.prototype.deriveAccount44 = function deriveAccount44(accountIndex, cache) {
  ...
  return this.derive(44, true, cache).derive(this.network.keyPrefix.coinType, true, cache).derive(accountIndex, true, cache);
};
