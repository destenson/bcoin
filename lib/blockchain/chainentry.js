...
ChainEntry.prototype.isGenesis = function isGenesis() {
  // console.log("GEN CHECK",this.hash , this.chain.network.genesis.hash,this.hash === this.chain.network.genesis.hash);
...
ChainEntry.prototype.fromRaw = function fromRaw(data) {
  var br = new BufferReader(data, false);
  var brR = br.readBytes(80);
  var hash = crypto.hash256(brR);
