...
DB.prototype.open = function open(options, callback) {
  ...
  this.level = new Level(this.location,options,callback);
  // console.log("DB INIT OPTIONS",this.location,options);
...
function Iterator(db, options) {
  ...
  this.db = db;
  // console.log("DLDLDLD", db);
  // console.log("DLDLDLDXXX", db.level);
  
  this.iter = db.level.db.iterator(options);
  // console.log("ITERATOR options", options, db.level, this.iter);
  this._end = false;
}
